    ...
    while True:
        ...
        for food_category in menu:
            ...
            # TODO: Extract the meal and the price for each option
                ...
                # TODO: Update the variable names in the following function //kept same names
        ...
        keep_going = input("Would you like to keep ordering? Type 'n' or 'N' to quit: ")
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        selection_number = int(menu_selection)


        # TODO: Check if the menu selection is in the menu items keys
        if selection_number in menu_items:
            ...
            quantity_input = input(f"How many of '{item_name}' would you like? ")

            # TODO: Check if the quantity is a number, default to 1 if not
            if quantity_input.isdigit():
                quantity = int(quantity_input)
            else:
                print("Invalid quantity. Adding 1 to your order")
                quantity = 1
            ...
            order.append({
                "Item name": item_name,
                "Price": menu_items[selection_number]["Price"],
                "Quantity": quantity
            })
    ...
    # TODO: Tell the customer they didn't select a menu option
        ...
        print(f"'{menu_selection}' is not valid. Please select a menu option.")
